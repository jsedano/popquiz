...
public class QuizController {
  ...
  public String saveQuizTitle(QuizDTO quizDTO, Model model) {
    model.addAttribute("question", QuestionDTO.builder().parentQuizUuid(quizService.initQuiz(quizDTO)).build());
    return "addQuestion";
  }
  ...
  public String addQuestion(@RequestParam String action, QuestionDTO questionDTO, Model model) {
    ...
    model.addAttribute("question", QuestionDTO.builder().parentQuizUuid(questionDTO.getParentQuizUuid()).build());
